...
extension GenericHash {
    public class Stream {
        ...
        private var opaqueState: UnsafeMutablePointer<crypto_generichash_state>//OpaquePointer
        ...
        init?(key: Bytes?, outputLength: Int) {
            ...
            opaqueState = UnsafeMutablePointer<crypto_generichash_state>(OpaquePointer(state.baseAddress!))//OpaquePointer(state.baseAddress!)
